...
class CourseOutlineTool(Tool):
    """Tool for retrieving a course's complete lesson outline from the catalog"""
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        return {
            ...
            "description": "Get the complete outline for a course: its title, link, and numbered lesson list",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_name": {
